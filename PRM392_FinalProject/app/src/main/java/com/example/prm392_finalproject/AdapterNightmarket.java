...
public class AdapterNightmarket extends RecyclerView.Adapter<NightmarketViewHolder> {
    private Context context;
    private List<Gun_skin> gun_skins;
    private LayoutInflater inflater;

    public AdapterNightmarket(Context context, List<Gun_skin> gun_skins) {
        this.context = context;
        this.gun_skins = gun_skins;
        inflater = LayoutInflater.from(context);
    }

    public AdapterNightmarket(Context context, List<Gun_skin> gun_skins, LayoutInflater inflater) {
        this.context = context;
        this.gun_skins = gun_skins;
