...
import com.example.prm392_finalproject.AdapterNightmarket;
...
import com.example.prm392_finalproject.MenuActivity;
...
public class ChoDemFragment extends Fragment {
    ...
    private void getData(View view) {
        ...
        if (ps.getCount() < 1) {
            textComing.setVisibility(view.VISIBLE);
            imageComing.setVisibility(view.VISIBLE);
            rcvmarket.setVisibility(view.INVISIBLE);
            ...
            textComing.setVisibility(view.INVISIBLE);
            imageComing.setVisibility(view.INVISIBLE);
            rcvmarket.setVisibility(view.VISIBLE);
    ...
    public void bindingView(View view){
        ...
        textComing = view.findViewById(R.id.textComing);
        imageComing = view.findViewById(R.id.imageComing);
        //get Userid session
    ...
    private void bindDataToRcvDictionary(View view) {
        ...
        rcvmarket.setAdapter(new AdapterNightmarket(view.getContext(),gunSkins));
    }
    @Override
